...
lims (asumiendo que el archivo esta ordenado por fecha)
y retornando el arbol */
...
de argumento (una fecha, un lugar y notificaciones) y un puntero a
fechas limite y agrega el registro a la tabla, y de ser necesario
agrega el lugar al arbol y actualiza los limites */
